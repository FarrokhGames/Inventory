...
namespace FarrokhGames
{
    ...
    IEndDragHandler, IPointerExitHandler, IPointerEnterHandler
    {
        ...
        */
        private Point ScreenToGrid(Vector2 screenPoint)
        {
            ...
            return new Point(Mathf.FloorToInt(pos.x / _renderer.CellSize.x), Mathf.FloorToInt(pos.y / _renderer.CellSize.y));
        }
