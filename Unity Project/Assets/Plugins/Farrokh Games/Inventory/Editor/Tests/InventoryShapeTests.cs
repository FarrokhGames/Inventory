...
namespace FarrokhGames.Inventory
{
    ...
    public class InventoryShapeTests
    {
        ...
        public void CTOR_PointsCalculated()
        {
            ...
            Assert.That(shape.Contains(Point.zero), Is.True);
            Assert.That(shape.Contains(Point.one), Is.True);
        }
        ...
        public void Position_Changed()
        {
            ...
            shape.Position = Point.one;
            Assert.That(shape.Position, Is.EqualTo(Point.one));
        }
        ...
        public void Position_PointsCalculated()
        {
            ...
            Assert.That(shape.Points.Count, Is.EqualTo(2));
            Assert.That(shape.Contains(new Point(6, 9)), Is.True);
            Assert.That(shape.Contains(new Point(7, 10)), Is.True);
        }
