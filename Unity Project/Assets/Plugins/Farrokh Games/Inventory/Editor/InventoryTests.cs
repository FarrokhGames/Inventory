...
namespace FarrokhGames
{
    ...
    {
        InventoryItem CreateFullItem(int width, int height)
        {
            ...
            return new InventoryItem("item", null, new InventoryShape(shape));
        }
        ...
        */
        ...
        {
            var inventory = new Inventory(16, 8);
        ...
        */
        ...
        {
            var inventory = new Inventory(8, 4);
        ...
        */
        ...
        {
            var inventory = new Inventory(1, 1);
            var callbacks = 0;
        ...
        */
        ...
        public void DropAll_OnItemDroppedInvokedForAllItems()
        {
            ...
            var droppedItems = new List<InventoryItem>();
            inventory.OnItemDropped += (i) =>
            {
                droppedItems.Add(i);
            };
